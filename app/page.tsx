...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 pt-12 text-center text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-end text-gray-500 pr-2 pt-10 pb-2">
          <a
            target="_blank"
            className="mr-1"
          ...
          icon by{" "}
          <a target="_blank" className="ml-1" href="https://icons8.com">
            Icons8
          </a>
        </div>
      </footer>
